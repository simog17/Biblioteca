...
namespace Library
{
    static class Seeder
    {
        ...
        private static int namesLength = names.Length;
        private static int surnamesLength = surnames.Length;
        private static int cfLength = cf.Length;
        ...
        {
            ;
            return new User(Select(ref names, namesLength), Select(ref surnames, surnamesLength), Select(ref cf, cfLength), SetDB());
        }
        ...
        private static int titlesLength = titles.Length;
        private static int authorsLength = authors.Length;
        private static int genresLength = genres.Length;
        ...
        {
            return new Book(Select(ref titles, titlesLength), Select(ref authors, authorsLength), SetIsbns(), Select(ref genres, genresLength));
        }
    }
